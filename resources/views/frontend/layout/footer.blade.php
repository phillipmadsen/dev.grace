<style>
.tagcloud a,#footer.litex .tagcloud a{background:none repeat scroll 0 0 #fefefe;border:2px solid #e1e1e1;border-radius:3px;color:#898989;display:inline-block;font-size:11px;font-weight:bold;line-height:16px;margin:0 5px 5px 0;min-width:18px;padding:4px 10px;text-decoration:none;text-transform:uppercase;width:auto;}
.tagcloud a:hover,#footer.litex .tagcloud a:hover{border-color:#ffcc00;color:#333;}
.tagcloud a{background:none repeat scroll 0 0 #363636;border:medium none;color:#808080;display:inline-block;margin:3px;padding:7px 14px;}
.tagcloud a:hover{background:none repeat scroll 0 0 #e84a52;color:#fff!important;}
.litex .footer-in .tagcloud a{color:#898989;}
.litex .footer-in .tagcloud a:hover{background:none repeat scroll 0 0 #fff;color:#333;}
</style>
    ...
    <div class="container">
        <div class="row">
            ...
            <address>
               ...
               <span itemprop="telephone"><abbr title="Phone">P:</abbr> +1(800)264-0644</span>
            </address>
            </div> 
...
<footer id="footer" class="midnight-blue">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                &copy; 2015 <a target="_blank" href="http://www.affordableprogrammer.com">Affordable Programmer</a> 
                <br>
                <br>
