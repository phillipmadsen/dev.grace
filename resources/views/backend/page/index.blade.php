...
@section('content')
    ...
    <section class="content-header">
        <h1> Pages  ({!! $pages->count() !!})<small> | Control Panel </small>  
    <small> </small><a href="{!! langRoute('admin.page.create') !!}" class="btn btn-primary"> <span class="glyphicon glyphicon-plus"></span>&nbsp;Add Page </a>
        </h1>   
        <ol class="breadcrumb">
